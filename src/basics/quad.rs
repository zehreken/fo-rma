...
const VERTICES: &[Vertex] = &[
    ...
    Vertex { position: [ 0.5, -0.5, 0.0], color: [1.0, 0.0, 0.0], normal: [0.0, 0.0, -1.0], uv: [10.0, 0.0] }, // Bottom-right
    Vertex { position: [ 0.5,  0.5, 0.0], color: [1.0, 0.0, 0.0], normal: [0.0, 0.0, -1.0], uv: [10.0, 10.0] }, // Top-right
    Vertex { position: [-0.5,  0.5, 0.0], color: [1.0, 0.0, 0.0], normal: [0.0, 0.0, -1.0], uv: [0.0, 10.0] }, // Top-left
];
